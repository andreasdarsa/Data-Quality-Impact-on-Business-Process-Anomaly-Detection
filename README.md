...
RQ2: Η αλλοίωση σε ποιες διαστάσεις ποιότητας επηρεάζει περισσότερο κάθε μέθοδο;
RQ3: Ποιου είδους ανωμαλίες επηρεάζει η υποβάθμιση ποιότητας σε κάθε διάσταση;
